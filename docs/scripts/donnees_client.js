...
var google_api_file_access = CryptoJS.AES.decrypt("U2FsdGVkX18e9HLphD2kSPwGelfcyT7Bgm4MBvFzxtUrXOjATvO54cCh49o//HcYVXi8qPYeEo9SibtUSWId8g==","Sekooly").toString(CryptoJS.enc.Utf8)



var site_actuel = window.location.href.split(".")[0]
var nom_etablissement = site_actuel.includes("localhost") ? "testo" : site_actuel.split('://')[1]
