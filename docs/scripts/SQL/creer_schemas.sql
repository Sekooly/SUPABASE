...
INSERT INTO public."Administration"(
    ...
    VALUES ('admin.tech', '444bcb3a3fcf8389296c49467f27e1d6', 'Aucun', '(Tous|aucun)', 'ok', '', 'oui', 'oui', 'oui', 'oui', 'Sekooly', 'ok', 'oui', 'Administration', '', '', 'Admin', 'Sekooly', 'contact@sekooly.com', '', '', '', null, 'Admin Sekooly', '');
...
(
    date_creation_note text COLLATE pg_catalog."default",
    identifiant_eleve text COLLATE pg_catalog."default",
    periode_bulletin text COLLATE pg_catalog."default",
    saison_note text COLLATE pg_catalog."default",
    "Classe_Matiere" text COLLATE pg_catalog."default",
    identifiant_prof text COLLATE pg_catalog."default",
    note real,
    id_note bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    CONSTRAINT "Notes_duplicate_pkey" PRIMARY KEY (id_note),
...
-- DROP VIEW public.bulletins;

CREATE OR REPLACE VIEW public.bulletins
 AS
 SELECT DISTINCT "Notes".id_note,
    "Eleves"."Classe",
    "Eleves"."Nom",
    "Eleves"."Prénom(s)",
    "Eleves"."Identifiant",
    "Notes"."Classe_Matiere",
    "Notes".identifiant_prof,
    "Notes".periode_bulletin,
    "Notes".saison_note,
    "Notes".note,
    "Eleves".liste_options,
    "Matieres".coefficient_matiere AS coef
   FROM "Eleves"
     LEFT JOIN "Notes" ON "Eleves"."Identifiant" = "Notes".identifiant_eleve
     LEFT JOIN "Matieres" ON "Notes"."Classe_Matiere" = "Matieres"."Classe_Matiere"
  ORDER BY "Eleves"."Nom", "Eleves"."Prénom(s)", "Notes".id_note;

ALTER TABLE public.bulletins
    OWNER TO supabase_admin;

GRANT ALL ON TABLE public.bulletins TO anon;
GRANT ALL ON TABLE public.bulletins TO postgres;
GRANT ALL ON TABLE public.bulletins TO supabase_admin;
...
(
    id bigint NOT NULL GENERATED BY DEFAULT AS IDENTITY ( INCREMENT 1 START 1 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
    horodateur timestamp with time zone DEFAULT now(),
    "Classe_Matiere" character varying COLLATE pg_catalog."default",
    identifiant_appreciateur character varying COLLATE pg_catalog."default",
    identifiant_eleve character varying COLLATE pg_catalog."default",
    periode_principale character varying COLLATE pg_catalog."default",
...
GRANT ALL ON TABLE public."Appreciations" TO postgres;
