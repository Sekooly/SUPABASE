...
(
    ...
    sexe character varying COLLATE pg_catalog."default" NOT NULL DEFAULT 'FM'::character varying,
...
(
    ...
    identifiant_appreciateur character varying COLLATE pg_catalog."default" NOT NULL,
